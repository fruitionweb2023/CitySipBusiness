...
public class DownloadTask {
    ...
    private String downloadUrl = "", downloadFileName = "", strName = "";
    ...
    public DownloadTask(Context context, String downloadUrl) {
        ...
        String downloadFileName1 = downloadUrl.substring(downloadUrl.lastIndexOf('='), downloadUrl.length()) + ".pdf";//Create file name by picking download file name from URL

        downloadFileName = downloadFileName1.replaceAll("[/,=]","_").substring(1);

        //downloadFileName = downloadUrl.replace(Api.url+"tcpdf/examples/order_report.php?order_date=","")+".pdf";//Create file name by picking download file name from URL
    ...
    public DownloadTask(Context context, String downloadUrl, String Name) {
        this.context = context;
        this.strName = Name;
        this.downloadUrl = downloadUrl;


        downloadFileName = strName+".pdf";
        //downloadFileName = downloadUrl.replace(Api.url+"tcpdf/examples/order_report.php?order_date=","")+".pdf";//Create file name by picking download file name from URL
        Log.e(TAG, downloadFileName);
        ...
        protected void onPostExecute(Void result) {
            try {
                if (outputFile != null) {
                    ...
                    ContextThemeWrapper ctw = new ContextThemeWrapper(context, R.style.Theme_AppCompat_Dialog_MinWidth);
