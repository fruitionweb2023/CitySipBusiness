...
import com.direct2web.citysip.databinding.RawInsurenceGetTimeListBinding;

import java.util.ArrayList;
import java.util.List;

public class InsurenceGetTimeListAdapter extends RecyclerView.Adapter<InsurenceGetTimeListAdapter.viewHolder> {
    ...
    public InsurenceGetTimeListAdapter(List<Timing> orderList, Context context, onClickSwitch onClickSwitch, onClickSwitchOff onClickSwitchOff) {
    ...
    @NonNull
    @Override
    public InsurenceGetTimeListAdapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        RawInsurenceGetTimeListBinding binding = DataBindingUtil.inflate(layoutInflater, R.layout.raw_insurence_get_time_list, parent, false);
        // set the view's size, margins, paddings and layout parameters
        return new viewHolder(binding);
    }

    @Override
    public void onBindViewHolder(@NonNull InsurenceGetTimeListAdapter.viewHolder holder, @SuppressLint("RecyclerView") int position) {
...
//                    holder.binding.llBottom.setBackground(context.getResources().getDrawable(R.drawable.eight_dp_corner_box_two_dp_thik));
    ...
    public class viewHolder extends RecyclerView.ViewHolder {
        ...
        RawInsurenceGetTimeListBinding binding;

        public viewHolder(@NonNull RawInsurenceGetTimeListBinding itemView) {
