...
public class InsuranceCustomListViewDialogWithSearchAdapter extends Dialog implements View.OnClickListener {
    ...
    InsuranceServiceTitleListAdapter adapter;
    List<ServiceList> newParties;
    LinearLayout ll_error;
    private RecyclerView.LayoutManager mLayoutManager;

    public InsuranceCustomListViewDialogWithSearchAdapter(Context context, int themeResId) {
        super(context, themeResId);
    }

    public InsuranceCustomListViewDialogWithSearchAdapter(Context context, boolean cancelable, OnCancelListener cancelListener) {
        super(context, cancelable, cancelListener);
    }


    public InsuranceCustomListViewDialogWithSearchAdapter(Activity a, InsuranceServiceTitleListAdapter adapter, List<ServiceList> newParties) {
        super(a);
        this.activity = a;
    ...
    public void filterCategory(String text) {
        ...
        ArrayList<ServiceList> temp = new ArrayList<>();

        if (newParties != null) {
            for (ServiceList d : newParties) {
