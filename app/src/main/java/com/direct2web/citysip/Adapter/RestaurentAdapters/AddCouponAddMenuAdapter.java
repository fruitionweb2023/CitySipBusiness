...
public class AddCouponAddMenuAdapter extends RecyclerView.Adapter<AddCouponAddMenuAdapter.ViewHolder> {

    Context context;
    List<Offer> stringArrayList;
    OnItemClickListner addButtonClick;
    OnCrossItemClickListner crossItemClickListner;

    public AddCouponAddMenuAdapter(Context context, List<Offer> stringArrayList, OnItemClickListner addButtonClick,OnCrossItemClickListner crossItemClickListner) {
    ...
    public void onBindViewHolder(ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        if (position == stringArrayList.size()) {
            ...
            holder.tittle.setText(stringArrayList.get(position).getCoupnCode());
