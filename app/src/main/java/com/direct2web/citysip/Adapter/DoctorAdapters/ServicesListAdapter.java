...
public class ServicesListAdapter extends RecyclerView.Adapter<ServicesListAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public ServicesListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        RawDoctorAddServicesBinding binding = DataBindingUtil.inflate(layoutInflater, R.layout.raw_doctor_add_services, parent, false);
...
//                    holder.binding.llBottom.setBackground(context.getResources().getDrawable(R.drawable.eight_dp_corner_box_two_dp_thik));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        RawDoctorAddServicesBinding binding;

        public ViewHolder(@NonNull RawDoctorAddServicesBinding itemView) {
