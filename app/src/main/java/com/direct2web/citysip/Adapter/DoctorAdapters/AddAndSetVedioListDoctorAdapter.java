...
public class AddAndSetVedioListDoctorAdapter extends RecyclerView.Adapter<AddAndSetVedioListDoctorAdapter.ViewHolder> {
    ...
    public AddAndSetVedioListDoctorAdapter(Context context, List<Video> videoList, OnItemClickListner addVedio, OnVideoItemClickListner playVedio) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View itemView;
        if (viewType == R.layout.property_doctor_add_image) {
            itemView = LayoutInflater.from(context).inflate(R.layout.property_doctor_add_image,viewGroup,false);
        } else {
    ...
    public int getItemViewType(int position) {
        return (position == videoList.size()) ? R.layout.property_doctor_add_image : R.layout.raw_video_rclr;
    }
