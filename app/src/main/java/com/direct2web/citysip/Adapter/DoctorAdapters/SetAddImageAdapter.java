...
public class SetAddImageAdapter extends RecyclerView.Adapter<SetAddImageAdapter.ViewHolder> {

    Context context;
    List<Image> stringArrayList;
    OnItemClickListner addButtonClick;

    public SetAddImageAdapter(Context context, List<Image> stringArrayList, OnItemClickListner addButtonClick ) {
