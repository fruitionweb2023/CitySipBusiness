...
public class AddAndSetImageListDoctorAdapter extends RecyclerView.Adapter<AddAndSetImageListDoctorAdapter.ViewHolder> {

    Context context;
    List<Image> stringArrayList;
    OnItemClickListner addButtonClick;

    public AddAndSetImageListDoctorAdapter(Context context, List<Image> stringArrayList, OnItemClickListner addButtonClick ) {
    ...
    public int getItemViewType(int position) {
        return (position == stringArrayList.size()) ? R.layout.property_doctor_add_image : R.layout.property_image_list;
    }
