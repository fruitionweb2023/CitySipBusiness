...
public class AddAndSetImageListLawyerAdapter extends RecyclerView.Adapter<AddAndSetImageListLawyerAdapter.ViewHolder> {

    Context context;
    List<Image> stringArrayList;
    OnItemClickListner addButtonClick;

    public AddAndSetImageListLawyerAdapter(Context context, List<Image> stringArrayList, OnItemClickListner addButtonClick ) {
    ...
    public int getItemViewType(int position) {
        return (position == stringArrayList.size()) ? R.layout.property_lawyer_add_image : R.layout.property_image_list;
    }
