...
public class DeleteVideoSpaAndSalonAdapter extends RecyclerView.Adapter<DeleteVideoSpaAndSalonAdapter.ViewHolder> {
    ...
    public DeleteVideoSpaAndSalonAdapter(Context context, List<Video> stringArrayList) {
