...
public class ServicesListSpaAndSalonAdapter extends RecyclerView.Adapter<ServicesListSpaAndSalonAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public ServicesListSpaAndSalonAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
