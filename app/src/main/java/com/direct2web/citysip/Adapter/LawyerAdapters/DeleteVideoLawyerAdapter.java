...
public class DeleteVideoLawyerAdapter extends RecyclerView.Adapter<DeleteVideoLawyerAdapter.ViewHolder> {
    ...
    public DeleteVideoLawyerAdapter(Context context, List<Video> stringArrayList) {
