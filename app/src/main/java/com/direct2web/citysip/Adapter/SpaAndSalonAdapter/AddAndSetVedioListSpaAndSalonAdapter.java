...
public class AddAndSetVedioListSpaAndSalonAdapter extends RecyclerView.Adapter<AddAndSetVedioListSpaAndSalonAdapter.ViewHolder> {
    ...
    public int getItemViewType(int position) {
        return (position == videoList.size()) ? R.layout.property_spa_salon_add_image : R.layout.raw_video_rclr;
    }
