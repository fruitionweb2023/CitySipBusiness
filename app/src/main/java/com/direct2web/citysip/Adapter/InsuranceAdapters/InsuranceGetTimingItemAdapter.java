...
public class InsuranceGetTimingItemAdapter extends RecyclerView.Adapter<InsuranceGetTimingItemAdapter.viewHolder> {
    ...
    public InsuranceGetTimingItemAdapter(List<AddSpecialTime> orderList, Context context) {
