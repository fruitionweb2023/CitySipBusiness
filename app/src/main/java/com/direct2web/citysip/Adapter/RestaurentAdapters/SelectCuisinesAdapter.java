...
public class SelectCuisinesAdapter extends RecyclerView.Adapter<SelectCuisinesAdapter.FruitViewHolder> {
    List<Cuisine> mDataset;
    RecyclerViewItemClickListener recyclerViewItemClickListener;

    public SelectCuisinesAdapter(List<Cuisine> myDataset, RecyclerViewItemClickListener listener) {
        mDataset = myDataset;
