...
public class DeleteImageDoctorAdapter extends RecyclerView.Adapter<DeleteImageDoctorAdapter.ViewHolder> {

    List<Image> imageList;
    Context context;

    public DeleteImageDoctorAdapter(List<Image> imageList, Context context) {
       /* this.imageList = imageList;
        this.context = context;*/
    }

    public DeleteImageDoctorAdapter(List<Image> imageList, DoctorDeleteImageActivity context) {
        this.imageList = imageList;
        this.context = context;
    }
