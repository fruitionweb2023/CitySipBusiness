...
public class GetTimingListAdapter extends RecyclerView.Adapter<GetTimingListAdapter.viewHolder> {
    ...
    public GetTimingListAdapter(List<Timing> orderList, Context context,onClickSwitch onClickSwitch,onClickSwitchOff onClickSwitchOff) {
    ...
    @NonNull
    @Override
    public GetTimingListAdapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        RawGetTimingListBinding binding = DataBindingUtil.inflate(layoutInflater, R.layout.raw_get_timing_list, parent, false);
        // set the view's size, margins, paddings and layout parameters
        return new viewHolder(binding);
    }

    @Override
    public void onBindViewHolder(@NonNull GetTimingListAdapter.viewHolder holder, @SuppressLint("RecyclerView") int position) {
...
//                    holder.binding.llBottom.setBackground(context.getResources().getDrawable(R.drawable.eight_dp_corner_box_two_dp_thik));
    ...
    public class viewHolder extends RecyclerView.ViewHolder {
        ...
        RawGetTimingListBinding binding;

        public viewHolder(@NonNull RawGetTimingListBinding itemView) {
