...
import com.direct2web.citysip.Adapter.DoctorAdapters.DoctorGetTimingItemAdapter;
...
public class InsuranceGetTimingListAdapter extends RecyclerView.Adapter<InsuranceGetTimingListAdapter.viewHolder> {
    ...
    public InsuranceGetTimingListAdapter(List<Timing> orderList, Context context) {
        this.orderList = orderList;
        this.context = context;

    }

    public InsuranceGetTimingListAdapter(List<Timing> orderList, Context context, onClickSwitch onClickSwitch, onClickSwitchOff onClickSwitchOff) {
        this.orderList = orderList;
        this.context = context;
...
//        holder.binding.txtRestTime.setText(order.getDay_time());
        ...
        InsuranceGetTimingItemAdapter orderItemAdapter = new InsuranceGetTimingItemAdapter(orderItemList, context);
