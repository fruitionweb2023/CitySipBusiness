...
public class DoctorGetTimingItemAdapter extends RecyclerView.Adapter<DoctorGetTimingItemAdapter.viewHolder> {
    ...
    public DoctorGetTimingItemAdapter(List<AddSpecialTime> orderList, Context context) {
