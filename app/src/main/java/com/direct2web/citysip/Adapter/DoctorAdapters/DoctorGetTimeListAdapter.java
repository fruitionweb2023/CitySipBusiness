...
import com.direct2web.citysip.databinding.RawGetTimingListBinding;

import java.util.ArrayList;
import java.util.List;

public class DoctorGetTimeListAdapter extends RecyclerView.Adapter<DoctorGetTimeListAdapter.viewHolder> {
    ...
    public DoctorGetTimeListAdapter(List<Timing> orderList, Context context, onClickSwitch onClickSwitch, onClickSwitchOff onClickSwitchOff) {
    ...
    @NonNull
    @Override
    public DoctorGetTimeListAdapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        RawDoctorGetTimeListBinding binding = DataBindingUtil.inflate(layoutInflater, R.layout.raw_doctor_get_time_list, parent, false);
        // set the view's size, margins, paddings and layout parameters
        return new viewHolder(binding);
    }

    @Override
    public void onBindViewHolder(@NonNull DoctorGetTimeListAdapter.viewHolder holder, @SuppressLint("RecyclerView") int position) {
...
//                    holder.binding.llBottom.setBackground(context.getResources().getDrawable(R.drawable.eight_dp_corner_box_two_dp_thik));
    ...
    public class viewHolder extends RecyclerView.ViewHolder {
        ...
        RawDoctorGetTimeListBinding binding;

        public viewHolder(@NonNull RawDoctorGetTimeListBinding itemView) {
