...
import com.direct2web.citysip.Activities.Lawyer.LawyerDeleteImageActivity;
...
public class DeleteImageLawyerAdapter extends RecyclerView.Adapter<DeleteImageLawyerAdapter.ViewHolder> {

    List<Image> imageList;
    Context context;


    public DeleteImageLawyerAdapter(List<Image> imageList, Context context) {
