...
public class DeleteVideoDoctorAdapter extends RecyclerView.Adapter<DeleteVideoDoctorAdapter.ViewHolder> {
    ...
    public DeleteVideoDoctorAdapter(Context context, List<Video> stringArrayList) {
