...
public class AddSpecialTimeAdapter extends RecyclerView.Adapter<AddSpecialTimeAdapter.CategoryViewHolder> {
    ...
    public AddSpecialTimeAdapter(Context context, ArrayList<AddSpecialTime> categoryList, onCanceDishTypellItem cancelItem) {
    ...
    @NonNull
    @Override
    public AddSpecialTimeAdapter.CategoryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AddSpecialTimeAdapter.CategoryViewHolder holder, @SuppressLint("RecyclerView") int position) {
    ...
    public class CategoryViewHolder extends RecyclerView.ViewHolder {
        ...
        public CategoryViewHolder(@NonNull RawTimingAddBinding itemView) {
