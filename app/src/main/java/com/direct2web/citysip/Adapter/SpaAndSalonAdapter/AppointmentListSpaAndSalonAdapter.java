...
public class AppointmentListSpaAndSalonAdapter extends RecyclerView.Adapter<AppointmentListSpaAndSalonAdapter.viewHolder> {
    ...
    public void onBindViewHolder(@NonNull AppointmentListSpaAndSalonAdapter.viewHolder holder, int position) {
        ...
        if (order.getStatus().equals("0")) {
            holder.binding.btnAccept.setBackgroundResource(R.drawable.button_spa_salon);
    ...
    private void status(String type, String id,String status) {
        ...
        Call<ResponManageStatus> call = api.getSpaAndSalonManageStatus("Bearer " + WS_URL_PARAMS.createJWT(WS_URL_PARAMS.issuer, WS_URL_PARAMS.subject),
