...
public class SetAddImageSpaAndSalonAdapter extends RecyclerView.Adapter<SetAddImageSpaAndSalonAdapter.ViewHolder> {

    Context context;
    List<Image> stringArrayList;
    OnItemClickListner addButtonClick;

    public SetAddImageSpaAndSalonAdapter(Context context, List<Image> stringArrayList, OnItemClickListner addButtonClick ) {
