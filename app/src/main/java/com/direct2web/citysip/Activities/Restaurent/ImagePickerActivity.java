...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    private void cropImage(Uri sourceUri) {
        ...
        // applying UI theme
        options.setToolbarColor(ContextCompat.getColor(this, R.color.clr_f54748));
        options.setStatusBarColor(ContextCompat.getColor(this, R.color.clr_f54748));
        options.setActiveControlsWidgetColor(ContextCompat.getColor(this, R.color.clr_f54748));
