...
public class DoctorAboutBusinessActivity extends AppCompatActivity {

    ActivityDoctorAboutBusinessBinding binding;
    ...
    private void getDoctorBusinessDetails(String userId) {
        ...
        Call<ResponseDoctorBusinessDetails> call = api.getDoctorBusinessDetails("Bearer " + WS_URL_PARAMS.createJWT(WS_URL_PARAMS.issuer, WS_URL_PARAMS.subject),
                WS_URL_PARAMS.access_key, userId);
        call.enqueue(new Callback<ResponseDoctorBusinessDetails>() {
            @Override
            public void onResponse(Call<ResponseDoctorBusinessDetails> call, Response<ResponseDoctorBusinessDetails> response) {
                ...
                if (response.body() != null && response.isSuccessful()) {
                    ...
                    if (response.body().getError()) {
                        ...
                        Toast.makeText(DoctorAboutBusinessActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
            ...
            @Override
            public void onFailure(Call<ResponseDoctorBusinessDetails> call, Throwable t) {
...
*/
    ...
    public void onBackPressed() {
        Intent i = new Intent(DoctorAboutBusinessActivity.this, DoctorBusinessProfileActivity.class);
        finish();
        startActivity(i);
    }
}