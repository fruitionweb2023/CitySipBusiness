...
public class DoctorEditAboutHospitalActivity extends AppCompatActivity {

    ActivityDoctorEditAboutHospitalBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_doctor_edit_about_hospital);
        ...
        binding.btnVerify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (binding.edtRestName.getText().toString().equals("")) {
                    ...
                    if (new ConnectionToInternet(DoctorEditAboutHospitalActivity.this).isConnectingToInternet()) {
                        editProfile(sessionManager.getUserId());
                    } else {
                        new ConnectionToInternet(DoctorEditAboutHospitalActivity.this).ShowDilog(DoctorEditAboutHospitalActivity.this);
                    }
                }
            }
        });
    ...
    private void editProfile(String userId) {
        ...
        pd = new ProgressDialog(DoctorEditAboutHospitalActivity.this);
            ...
            public void onResponse(Call<ResponseSendProfile> call, Response<ResponseSendProfile> response) {
                ...
                if (response.body() != null && response.isSuccessful()){
                    ...
                    if (!response.body().getError()){
                        ...
                        Intent i = new Intent(DoctorEditAboutHospitalActivity.this, DoctorAboutBusinessActivity.class);
                        finish();
                        startActivity(i);

                    }else {
                        Toast.makeText(DoctorEditAboutHospitalActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
                    }

                }else {
                    Toast.makeText(DoctorEditAboutHospitalActivity.this, getResources().getString(R.string.error_admin), Toast.LENGTH_SHORT).show();
