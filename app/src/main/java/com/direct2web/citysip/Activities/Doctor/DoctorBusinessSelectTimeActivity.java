...
import com.direct2web.citysip.databinding.ActivitySelectTimingBinding;
...
public class DoctorBusinessSelectTimeActivity extends AppCompatActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener, AddSpecialTimeAdapter.onCanceDishTypellItem {

    ActivityDoctorBusinessSelectTimeBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_doctor_business_select_time);
        ...
        titleListAdapter = new SpinnerTimingTitleListAdapter(DoctorBusinessSelectTimeActivity.this, R.layout.raw_recyclear_view_drop_down_timing, R.id.tvName, hourTitleList);
        ...
        binding.txtSelectFromTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog datePickerDialog = new TimePickerDialog(DoctorBusinessSelectTimeActivity.this, android.R.style.Theme_Holo_Light_Dialog, time, calendar1
        ...
        binding.btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (add_open.equals("0") && add_close.equals("0")){
                    ...
                    Toast.makeText(DoctorBusinessSelectTimeActivity.this, "Please Select Time", Toast.LENGTH_SHORT).show();
                    ...
                    if (specialTimeList.size() == 0) {
                        ...
                        typeListAdapter = new AddSpecialTimeAdapter(DoctorBusinessSelectTimeActivity.this, specialTimeList, DoctorBusinessSelectTimeActivity.this);
                        LinearLayoutManager layoutManager = new LinearLayoutManager(DoctorBusinessSelectTimeActivity.this);
                        ...
                        for (AddSpecialTime d : specialTimeList) {
                            if (d.getTitle().equals(hoursTitle)) {
                                Toast.makeText(DoctorBusinessSelectTimeActivity.this, "title already available", Toast.LENGTH_SHORT).show();
                                flag = true;
                            }
                        }
                        if (!flag) {
    ...
    private void getData(String cat_id) {
        ...
        pd = new ProgressDialog(DoctorBusinessSelectTimeActivity.this);
        pd.setMessage("Please Wait.....");
        pd.setCancelable(false);
        pd.show();

        Api api = RetrofitClient.getClient().create(Api.class);
        Call<ResponseHoursTitleList> call = api.getDoctorHoursTitleList("Bearer " + WS_URL_PARAMS.createJWT(WS_URL_PARAMS.issuer, WS_URL_PARAMS.subject),
            ...
            public void onResponse(Call<ResponseHoursTitleList> call, Response<ResponseHoursTitleList> response) {
                ...
                if (response.body() != null && response.isSuccessful()) {
                    ...
                    if (response.body().getError()) {
                        ...
                        Toast.makeText(DoctorBusinessSelectTimeActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(DoctorBusinessSelectTimeActivity.this, getResources().getString(R.string.error_admin), Toast.LENGTH_SHORT).show();
    ...
    public void sendData() {
        ...
        if (sunday.equals("0") && monday.equals("0") && tuesday.equals("0") && wednesday.equals("0") && thursday.equals("0") && friday.equals("0") && saturday.equals("0")) {
            ...
            pd.dismiss();
            Toast.makeText(DoctorBusinessSelectTimeActivity.this, "Please Select WeekDays", Toast.LENGTH_SHORT).show();


        } else if (rest_open.equals("0")) {
            pd.dismiss();
            Toast.makeText(DoctorBusinessSelectTimeActivity.this, "Please Select restaurant Open Time", Toast.LENGTH_SHORT).show();
        } else if (rest_close.equals("0")) {
            pd.dismiss();
            Toast.makeText(DoctorBusinessSelectTimeActivity.this, "Please Select restaurant Close Time", Toast.LENGTH_SHORT).show();
        } else {
            ...
            Api api = RetrofitClient.getClient().create(Api.class);
            Call<ResponseSendTiming> call = api.sendDoctorTiming("Bearer " + WS_URL_PARAMS.createJWT(WS_URL_PARAMS.issuer, WS_URL_PARAMS.subject),
                ...
                public void onResponse(Call<ResponseSendTiming> call, Response<ResponseSendTiming> response) {
                    ...
                    if (response.body() != null && response.isSuccessful()) {
                        ...
                        if (response.body().getError()) {
                            ...
                            Intent intent = new Intent(DoctorBusinessSelectTimeActivity.this, DoctorBusinessTimingListActivity.class);
                            finish();
