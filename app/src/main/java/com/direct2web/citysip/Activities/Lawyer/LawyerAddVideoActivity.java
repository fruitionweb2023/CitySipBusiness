...
import com.direct2web.citysip.databinding.ActivityLawyerAddVedioBinding;
...
public class LawyerAddVideoActivity extends AppCompatActivity implements AddAndSetVedioListLawyerAdapter.OnItemClickListner {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_lawyer_add_vedio);
        ...
        binding.imgDelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(LawyerAddVideoActivity.this, DoctorDeleteVideoActivity.class);
        ...
        if (requestCode == REQUEST_TAKE_GALLERY_VIDEO) {
            if (resultCode == RESULT_OK) {
                ...
                if (path != null) {
                    ...
                    if (file.exists()) {
                        startActivityForResult(new Intent(LawyerAddVideoActivity.this,
                                        VideoTrimmerActivity.class).putExtra("EXTRA_PATH", path),
                                VIDEO_TRIM);
                        overridePendingTransition(0, 0);
                    } else {
                        Toast.makeText(LawyerAddVideoActivity.this, "Please select proper video", Toast.LENGTH_LONG);
                    }
                }
            }
            ...
            if (resultCode == RESULT_OK) {
                if (data != null) {
                    ...
                    Toast.makeText(LawyerAddVideoActivity.this, videoPath, Toast.LENGTH_LONG).show();
                }
            }
        }
    }
    ...
    private String getPath2(Uri uri) {
        ...
        if (isKitKat && DocumentsContract.isDocumentUri(this, uri)) {
            ...
            // DownloadsProvider
                ...
                return getDataColumn(LawyerAddVideoActivity.this, contentUri, null, null);
            }
            // MediaProvider
            ...
            public void onResponse(Call<ResponseLawyerAddImageAndVedio> call, Response<ResponseLawyerAddImageAndVedio> response) {
                ...
                if (response.body() != null && response.isSuccessful()) {
                    ...
                    if (response.body().getError()) {
                        Toast.makeText(LawyerAddVideoActivity.this, "" + response.body().getMessage(), Toast.LENGTH_SHORT).show();
                    } else {
                    ...
                    Toast.makeText(LawyerAddVideoActivity.this, getResources().getString(R.string.error_admin), Toast.LENGTH_SHORT).show();
    ...
    public void sendData() {
        ...
        pd = new ProgressDialog(LawyerAddVideoActivity.this);
        pd.setMessage("Please Wait.....");
        pd.setCancelable(false);
        pd.show();
        ...
        Call<ResponseLawyerAddVedio> call = api.sendLawyerVideoFrom(header, t2, t1, body);
        call.enqueue(new Callback<ResponseLawyerAddVedio>() {
            @Override
            public void onResponse(Call<ResponseLawyerAddVedio> call, Response<ResponseLawyerAddVedio> response) {
                ...
                if (response.body() != null && response.isSuccessful()) {
                    ...
                    if (response.body().getError()) {
                        ...
                        Toast.makeText(LawyerAddVideoActivity.this, "Successfully Updated", Toast.LENGTH_SHORT).show();
                    }
                }
            }

            @Override
            public void onFailure(Call<ResponseLawyerAddVedio> call, Throwable t) {
