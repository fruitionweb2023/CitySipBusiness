...
import com.direct2web.citysip.databinding.ActivityLawyerEditLocationFetchBinding;
...
public class LawyerEditLocationFetchActivity extends FragmentActivity implements OnMapReadyCallback, LocationListener, GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener {

    ActivityLawyerEditLocationFetchBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_lawyer_edit_location_fetch);
        ...
        binding.btnVerify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (address.equals("")) {
                    ...
                    Toast.makeText(LawyerEditLocationFetchActivity.this, "Please Wait", Toast.LENGTH_SHORT).show();
                    ...
                    if (new ConnectionToInternet(LawyerEditLocationFetchActivity.this).isConnectingToInternet()) {
                        sendProfile(sessionManager.getUserId());
                    } else {
                        new ConnectionToInternet(LawyerEditLocationFetchActivity.this).ShowDilog(LawyerEditLocationFetchActivity.this);
                    }
                }
    ...
    private void sendProfile(String userId) {
        ...
        pd = new ProgressDialog(LawyerEditLocationFetchActivity.this);
            ...
            public void onResponse(Call<ResponseSendProfile> call, Response<ResponseSendProfile> response) {
                ...
                if (response.body() != null && response.isSuccessful()) {
                    ...
                    if (!response.body().getError()) {
                        ...
                        Intent i = new Intent(LawyerEditLocationFetchActivity.this, LawyerAboutBusinessActivity.class);
                        finish();
                        startActivity(i);

                    } else {
                        Toast.makeText(LawyerEditLocationFetchActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
                    }

                } else {
                    Toast.makeText(LawyerEditLocationFetchActivity.this, getResources().getString(R.string.error_admin), Toast.LENGTH_SHORT).show();
    ...
    private void configureCameraIdle() {
        onCameraIdleListener = new GoogleMap.OnCameraIdleListener() {
            ...
            public void onCameraIdle() {
                ...
                Geocoder geocoder = new Geocoder(LawyerEditLocationFetchActivity.this);
...
//                        String city = addressList.get(0).get();
    ...
    public void onBackPressed() {
        Intent i = new Intent(LawyerEditLocationFetchActivity.this, DoctorAboutBusinessActivity.class);
        finish();
        startActivity(i);
    }
}
