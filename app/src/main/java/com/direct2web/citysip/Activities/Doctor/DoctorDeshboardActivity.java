...
public class DoctorDeshboardActivity extends AppCompatActivity {

    ActivityDoctorDeshboardBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_doctor_deshboard);
        ...
        binding.txtOrderView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DoctorDeshboardActivity.this,DoctorAppointmentActivity.class);
        ...
        binding.txtCustomerView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DoctorDeshboardActivity.this, DoctorCustomerActivity.class);
                startActivity(intent);
            }
        });
        ...
        binding.txtInActiveMenu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DoctorDeshboardActivity.this, DoctorServicesActivity.class);
                startActivity(intent);
            }
        });
        ...
        binding.txtActiveOffer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DoctorDeshboardActivity.this, DoctorCouponsActivity.class);
                startActivity(intent);
            }
        });
    ...
    private void getDashboardData(String userId) {
        ...
        pd = new ProgressDialog(DoctorDeshboardActivity.this);
        ...
        Call<ResponseDoctorDeshboard> call = api.getDeshboardDetails("Bearer " + WS_URL_PARAMS.createJWT(WS_URL_PARAMS.issuer, WS_URL_PARAMS.subject),
                WS_URL_PARAMS.access_key, userId);

        call.enqueue(new Callback<ResponseDoctorDeshboard>() {
            @Override
            public void onResponse(Call<ResponseDoctorDeshboard> call, Response<ResponseDoctorDeshboard> response) {
                ...
                if (response.body() != null && response.isSuccessful()) {
                    ...
                    if (response.body().getError()) {
                        ...
                        Toast.makeText(DoctorDeshboardActivity.this, "Error", Toast.LENGTH_SHORT).show();
                    } else {
                    ...
                    Toast.makeText(DoctorDeshboardActivity.this, getResources().getString(R.string.error_admin), Toast.LENGTH_SHORT).show();

                }
            }

            @Override
            public void onFailure(Call<ResponseDoctorDeshboard> call, Throwable t) {
                if (pd.isShowing()) {
                    pd.dismiss();
                }
                t.printStackTrace();
    ...
    public void onBackPressed() {
        if (doubleBackToExitPressedOnce) {
            Intent intent = new Intent(DoctorDeshboardActivity.this, CategoryActivity.class);
            startActivity(intent);
            return;
        }
