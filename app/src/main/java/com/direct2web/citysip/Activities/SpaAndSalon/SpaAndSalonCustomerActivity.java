...
import com.direct2web.citysip.databinding.ActivitySpaSalonCustomerBinding;
...
public class SpaAndSalonCustomerActivity extends AppCompatActivity {

    ActivitySpaSalonCustomerBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_spa_salon_customer);
...
*/
    ...
    private void getData(String userId) {
        ...
        pd = new ProgressDialog(SpaAndSalonCustomerActivity.this);
        pd.setMessage("Please Wait....");
        pd.setCancelable(false);
        pd.show();

        Api api = RetrofitClient.getClient().create(Api.class);
        Call<ResponseCustomerList> call = api.getSpaAndSalonCustomerList("Bearer " + WS_URL_PARAMS.createJWT(WS_URL_PARAMS.issuer, WS_URL_PARAMS.subject),
            ...
            public void onResponse(Call<ResponseCustomerList> call, Response<ResponseCustomerList> response) {
                ...
                if (response.body() != null && response.isSuccessful()) {
                    ...
                    if (response.body().getError()) {
                        ...
                        Toast.makeText(SpaAndSalonCustomerActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();

                    } else {

                        customerList = response.body().getCustomerList();

                        adapter = new CustomerListAdapter(customerList, SpaAndSalonCustomerActivity.this);

                        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(SpaAndSalonCustomerActivity.this);
                    ...
                    Toast.makeText(SpaAndSalonCustomerActivity.this, getResources().getString(R.string.error_admin), Toast.LENGTH_SHORT).show();
