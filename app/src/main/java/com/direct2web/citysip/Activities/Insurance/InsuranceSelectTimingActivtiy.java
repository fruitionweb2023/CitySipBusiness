...
import com.direct2web.citysip.Activities.Doctor.DoctorSetUpTimingListActivity;
...
import com.direct2web.citysip.Adapter.InsuranceAdapters.InsuranceAddSpecialTimeAdapter;
...
import com.direct2web.citysip.databinding.ActivityInsuranceSelectTimingActivtiyBinding;
...
public class InsuranceSelectTimingActivtiy extends AppCompatActivity implements View.OnClickListener, InsuranceAddSpecialTimeAdapter.onCanceDishTypellItem, DoctorSpinnerTimingTitleListAdapter.RecyclerViewItemClickListener {


    ActivityInsuranceSelectTimingActivtiyBinding binding;
    ...
    String add_open = "0", add_close = "0", hoursTitle = "", hoursId="0";
    Calendar myCalendar = Calendar.getInstance();
    private static int flag_calander = 0;


    ArrayList<AddSpecialTime> specialTimeList = new ArrayList<>();
    InsuranceAddSpecialTimeAdapter doctorAddSpecialTimeAdapter;
    boolean goIn = true;
...
//        getServiceList(sessionManager.getUserId());
        ...
        /*binding.spinnerTitle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                titleListAdapter = new DoctorSpinnerTimingTitleListAdapter( temp, InsuranceSelectTimingActivtiy.this);
                customDialog = new CustomListViewDialogWithSearch(InsuranceSelectTimingActivtiy.this, titleListAdapter,temp);
        ...
        binding.txtAddSelectFromTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog datePickerDialog = new TimePickerDialog(InsuranceSelectTimingActivtiy.this, time, calendar1
        ...
        binding.btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (add_open.equals("0") && add_close.equals("0")){
                    ...
                    Toast.makeText(InsuranceSelectTimingActivtiy.this, "Please Select Time", Toast.LENGTH_SHORT).show();
                    ...
                    if (specialTimeList.size() == 0) {
                        ...
                        doctorAddSpecialTimeAdapter = new InsuranceAddSpecialTimeAdapter(InsuranceSelectTimingActivtiy.this, specialTimeList, InsuranceSelectTimingActivtiy.this);
                        LinearLayoutManager layoutManager = new LinearLayoutManager(InsuranceSelectTimingActivtiy.this);
                        ...
                        for (AddSpecialTime d : specialTimeList) {
                            if (d.getTime().equals(add_open + "-" + add_close)) {
                                Toast.makeText(InsuranceSelectTimingActivtiy.this, "time already available", Toast.LENGTH_SHORT).show();
                                flag = true;
                            }else if (checkTime(d.getInTime(),d.getOutTime(),add_open)){
                                Toast.makeText(InsuranceSelectTimingActivtiy.this, "between time already available", Toast.LENGTH_SHORT).show();
                                flag = true;
                            }
                        }
    ...
    private void getServiceList(String userId) {
        ...
        pd = new ProgressDialog(InsuranceSelectTimingActivtiy.this);
            ...
            public void onResponse(Call<ResponseDoctorServices> call, Response<ResponseDoctorServices> response) {
                ...
                if (response.body() != null && response.isSuccessful()) {
                    ...
                    if (response.body().getError()) {
                        ...
                        Toast.makeText(InsuranceSelectTimingActivtiy.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
        ...
        switch (v.getId()) {
            ...
            case R.id.txt_monday:
                if (bMonday) {
                    ...
                    binding.txtMonday.setBackground(getResources().getDrawable(R.drawable.select_week_days_insurance));
            ...
            case R.id.txt_tuesday:
                if (bTuesday) {
                    ...
                    binding.txtTuesday.setBackground(getResources().getDrawable(R.drawable.select_week_days_insurance));
            ...
            case R.id.txt_wednesday:
                if (bWednesday) {
                    ...
                    binding.txtWednesday.setBackground(getResources().getDrawable(R.drawable.select_week_days_insurance));
            ...
            case R.id.txt_thursday:
                if (bThursday) {
                    ...
                    binding.txtThursday.setBackground(getResources().getDrawable(R.drawable.select_week_days_insurance));
            ...
            case R.id.txt_friday:
                if (bFriday) {
                    ...
                    binding.txtFriday.setBackground(getResources().getDrawable(R.drawable.select_week_days_insurance));
            ...
            case R.id.txt_saturday:
                if (bSaturday) {
                    ...
                    binding.txtSaturday.setBackground(getResources().getDrawable(R.drawable.select_week_days_insurance));
            ...
            case R.id.txt_sunday:
                if (bSunday) {
                    ...
                    binding.txtSunday.setBackground(getResources().getDrawable(R.drawable.select_week_days_insurance));
    ...
    public void sendData() {
        ...
        if (sunday.equals("0") && monday.equals("0") && tuesday.equals("0") && wednesday.equals("0") && thursday.equals("0") && friday.equals("0") && saturday.equals("0")) {
            ...
            pd.dismiss();
            Toast.makeText(InsuranceSelectTimingActivtiy.this, "Please Select WeekDays", Toast.LENGTH_SHORT).show();


        } else if (add_open.equals("0")) {
            pd.dismiss();
            Toast.makeText(InsuranceSelectTimingActivtiy.this, "Please Select restaurant Open Time", Toast.LENGTH_SHORT).show();
        } else if (add_close.equals("0")) {
            pd.dismiss();
            Toast.makeText(InsuranceSelectTimingActivtiy.this, "Please Select restaurant Close Time", Toast.LENGTH_SHORT).show();
        } else {
            ...
            call.enqueue(new Callback<ResponseDoctorSendTiming>() {
                ...
                public void onResponse(Call<ResponseDoctorSendTiming> call, Response<ResponseDoctorSendTiming> response) {
                    ...
                    if (response.body() != null && response.isSuccessful()) {
                        ...
                        Toast.makeText(InsuranceSelectTimingActivtiy.this, getResources().getString(R.string.error_admin), Toast.LENGTH_SHORT).show();
                    }
