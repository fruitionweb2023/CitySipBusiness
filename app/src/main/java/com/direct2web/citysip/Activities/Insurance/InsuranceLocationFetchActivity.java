...
import com.direct2web.citysip.databinding.ActivityInsuranceLocationFetchBinding;
...
public class InsuranceLocationFetchActivity extends FragmentActivity implements OnMapReadyCallback, LocationListener, GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener {

    ActivityInsuranceLocationFetchBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_insurance_location_fetch);
        ...
        binding.btnVerify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (address.equals("")) {
                    ...
                    Toast.makeText(InsuranceLocationFetchActivity.this, "Please Wait", Toast.LENGTH_SHORT).show();
                    ...
                    if (new ConnectionToInternet(InsuranceLocationFetchActivity.this).isConnectingToInternet()) {
                        sendProfile(sessionManager.getUserId());
                    } else {
                        new ConnectionToInternet(InsuranceLocationFetchActivity.this).ShowDilog(InsuranceLocationFetchActivity.this);
                    }
                }
    ...
    private void sendProfile(String userId) {
        ...
        pd = new ProgressDialog(InsuranceLocationFetchActivity.this);
            ...
            public void onResponse(Call<ResponseInsuranceSaveProfile> call, Response<ResponseInsuranceSaveProfile> response) {
                ...
                if (response.body() != null && response.isSuccessful()) {
                    ...
                    if (!response.body().getError()) {
                        ...
                        Intent i = new Intent(InsuranceLocationFetchActivity.this, InsuranceDashboardActivity.class);
                        finish();
                        startActivity(i);

                    } else {
                        Toast.makeText(InsuranceLocationFetchActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
                    }

                } else {
                    Toast.makeText(InsuranceLocationFetchActivity.this, getResources().getString(R.string.error_admin), Toast.LENGTH_SHORT).show();
    ...
    private void configureCameraIdle() {
        onCameraIdleListener = new GoogleMap.OnCameraIdleListener() {
            ...
            public void onCameraIdle() {
                ...
                Geocoder geocoder = new Geocoder(InsuranceLocationFetchActivity.this);
