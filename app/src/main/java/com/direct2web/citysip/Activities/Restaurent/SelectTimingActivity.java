...
public class SelectTimingActivity extends AppCompatActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener, AddSpecialTimeAdapter.onCanceDishTypellItem {
        ...
        switch (v.getId()) {
            ...
            case R.id.txt_monday:
                if (bMonday) {
                    ...
                    binding.txtMonday.setBackground(getResources().getDrawable(R.drawable.select_weekdays));
            ...
            case R.id.txt_tuesday:
                if (bTuesday) {
                    ...
                    binding.txtTuesday.setBackground(getResources().getDrawable(R.drawable.select_weekdays));
            ...
            case R.id.txt_wednesday:
                if (bWednesday) {
                    ...
                    binding.txtWednesday.setBackground(getResources().getDrawable(R.drawable.select_weekdays));
            ...
            case R.id.txt_thursday:
                if (bThursday) {
                    ...
                    binding.txtThursday.setBackground(getResources().getDrawable(R.drawable.select_weekdays));
            ...
            case R.id.txt_friday:
                if (bFriday) {
                    ...
                    binding.txtFriday.setBackground(getResources().getDrawable(R.drawable.select_weekdays));
            ...
            case R.id.txt_saturday:
                if (bSaturday) {
                    ...
                    binding.txtSaturday.setBackground(getResources().getDrawable(R.drawable.select_weekdays));
            ...
            case R.id.txt_sunday:
                if (bSunday) {
                    ...
                    binding.txtSunday.setBackground(getResources().getDrawable(R.drawable.select_weekdays));
    ...
    private void getData(String cat_id) {
        ...
        Call<ResponseHoursTitleList> call = api.getHoursTitleList("Bearer " + WS_URL_PARAMS.createJWT(WS_URL_PARAMS.issuer, WS_URL_PARAMS.subject),
    ...
    public void sendData() {
        ...
        if (sunday.equals("0") && monday.equals("0") && tuesday.equals("0") && wednesday.equals("0") && thursday.equals("0") && friday.equals("0") && saturday.equals("0")) {
            ...
            Api api = RetrofitClient.getClient().create(Api.class);
            Call<ResponseSendTiming> call = api.sendTiming("Bearer " + WS_URL_PARAMS.createJWT(WS_URL_PARAMS.issuer, WS_URL_PARAMS.subject),
