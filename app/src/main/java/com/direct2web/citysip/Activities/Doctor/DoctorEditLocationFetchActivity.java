...
public class DoctorEditLocationFetchActivity extends FragmentActivity implements OnMapReadyCallback, LocationListener, GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener {

    ActivityDoctorEditLocationFetchBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_doctor_edit_location_fetch);
        ...
        binding.btnVerify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (address.equals("")) {
                    ...
                    Toast.makeText(DoctorEditLocationFetchActivity.this, "Please Wait", Toast.LENGTH_SHORT).show();
                    ...
                    if (new ConnectionToInternet(DoctorEditLocationFetchActivity.this).isConnectingToInternet()) {
                        sendProfile(sessionManager.getUserId());
                    } else {
                        new ConnectionToInternet(DoctorEditLocationFetchActivity.this).ShowDilog(DoctorEditLocationFetchActivity.this);
                    }
                }
    ...
    private void sendProfile(String userId) {
        ...
        pd = new ProgressDialog(DoctorEditLocationFetchActivity.this);
            ...
            public void onResponse(Call<ResponseSendProfile> call, Response<ResponseSendProfile> response) {
                ...
                if (response.body() != null && response.isSuccessful()) {
                    ...
                    if (!response.body().getError()) {
                        ...
                        Intent i = new Intent(DoctorEditLocationFetchActivity.this, DoctorAboutBusinessActivity.class);
                        finish();
                        startActivity(i);

                    } else {
                        Toast.makeText(DoctorEditLocationFetchActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
                    }

                } else {
                    Toast.makeText(DoctorEditLocationFetchActivity.this, getResources().getString(R.string.error_admin), Toast.LENGTH_SHORT).show();
    ...
    private void configureCameraIdle() {
        onCameraIdleListener = new GoogleMap.OnCameraIdleListener() {
            ...
            public void onCameraIdle() {
                ...
                Geocoder geocoder = new Geocoder(DoctorEditLocationFetchActivity.this);
