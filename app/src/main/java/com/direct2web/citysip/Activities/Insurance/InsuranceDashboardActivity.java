...
import com.direct2web.citysip.databinding.ActivityInsuranceDeshboardBinding;
...
public class InsuranceDashboardActivity extends AppCompatActivity {

    ActivityInsuranceDeshboardBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_insurance_deshboard);
        ...
        binding.txtOrderView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(InsuranceDashboardActivity.this, InsuranceAppointmentActivity.class);
        ...
        binding.txtCustomerView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(InsuranceDashboardActivity.this, InsuranceCustomerActivity.class);
                startActivity(intent);
            }
        });
        ...
        binding.txtInActiveMenu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(InsuranceDashboardActivity.this, InsuranceServicesActivity.class);
                startActivity(intent);
            }
        });
    ...
    private void getDashboardData(String userId) {
        ...
        pd = new ProgressDialog(InsuranceDashboardActivity.this);
        ...
        Call<ResponseInsuranceDeshboard> call = api.getInsuranceDashboardDetails("Bearer " + WS_URL_PARAMS.createJWT(WS_URL_PARAMS.issuer, WS_URL_PARAMS.subject),
                WS_URL_PARAMS.access_key, userId);

        call.enqueue(new Callback<ResponseInsuranceDeshboard>() {
            @Override
            public void onResponse(Call<ResponseInsuranceDeshboard> call, Response<ResponseInsuranceDeshboard> response) {
                ...
                if (response.body() != null && response.isSuccessful()) {
                    ...
                    if (response.body().getError()) {
                        ...
                        Toast.makeText(InsuranceDashboardActivity.this, "Error", Toast.LENGTH_SHORT).show();
                    } else {
...
//                        binding.txtInActiveOffer.setText(""+response.body().getInactiveOffer());
                    ...
                    Toast.makeText(InsuranceDashboardActivity.this, getResources().getString(R.string.error_admin), Toast.LENGTH_SHORT).show();

                }
            }

            @Override
            public void onFailure(Call<ResponseInsuranceDeshboard> call, Throwable t) {
                if (pd.isShowing()) {
                    pd.dismiss();
                }
                t.printStackTrace();
    ...
    public void onBackPressed() {
        if (doubleBackToExitPressedOnce) {
            Intent intent = new Intent(InsuranceDashboardActivity.this, CategoryActivity.class);
            startActivity(intent);
            return;
        }
