...
import com.direct2web.citysip.databinding.ActivitySpaAndSalonBusinessSelectTimeBinding;
...
public class SpaAndSalonBusinessSelectTimeActivity extends AppCompatActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener, AddSpecialTimeAdapter.onCanceDishTypellItem {

    ActivitySpaAndSalonBusinessSelectTimeBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_spa_and_salon_business_select_time);
        ...
        titleListAdapter = new SpinnerTimingTitleListAdapter(SpaAndSalonBusinessSelectTimeActivity.this, R.layout.raw_recyclear_view_drop_down_timing, R.id.tvName, hourTitleList);
        ...
        binding.txtSelectFromTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog datePickerDialog = new TimePickerDialog(SpaAndSalonBusinessSelectTimeActivity.this, android.R.style.Theme_Holo_Light_Dialog, time, calendar1
        ...
        binding.btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (add_open.equals("0") && add_close.equals("0")){
                    ...
                    Toast.makeText(SpaAndSalonBusinessSelectTimeActivity.this, "Please Select Time", Toast.LENGTH_SHORT).show();
                    ...
                    if (specialTimeList.size() == 0) {
                        ...
                        typeListAdapter = new AddSpecialTimeAdapter(SpaAndSalonBusinessSelectTimeActivity.this, specialTimeList, SpaAndSalonBusinessSelectTimeActivity.this);
                        LinearLayoutManager layoutManager = new LinearLayoutManager(SpaAndSalonBusinessSelectTimeActivity.this);
                        ...
                        for (AddSpecialTime d : specialTimeList) {
                            if (d.getTitle().equals(hoursTitle)) {
                                Toast.makeText(SpaAndSalonBusinessSelectTimeActivity.this, "title already available", Toast.LENGTH_SHORT).show();
                                flag = true;
                            }
                        }
                        if (!flag) {
        ...
        switch (v.getId()) {
            ...
            case R.id.txt_monday:
                if (bMonday) {
                    ...
                    binding.txtMonday.setBackground(getResources().getDrawable(R.drawable.circle_spa_salon_doctor));
            ...
            case R.id.txt_tuesday:
                if (bTuesday) {
                    ...
                    binding.txtTuesday.setBackground(getResources().getDrawable(R.drawable.circle_spa_salon_doctor));
            ...
            case R.id.txt_wednesday:
                if (bWednesday) {
                    ...
                    binding.txtWednesday.setBackground(getResources().getDrawable(R.drawable.circle_spa_salon_doctor));
            ...
            case R.id.txt_thursday:
                if (bThursday) {
                    ...
                    binding.txtThursday.setBackground(getResources().getDrawable(R.drawable.circle_spa_salon_doctor));
            ...
            case R.id.txt_friday:
                if (bFriday) {
                    ...
                    binding.txtFriday.setBackground(getResources().getDrawable(R.drawable.circle_spa_salon_doctor));
            ...
            case R.id.txt_saturday:
                if (bSaturday) {
                    ...
                    binding.txtSaturday.setBackground(getResources().getDrawable(R.drawable.circle_spa_salon_doctor));
            ...
            case R.id.txt_sunday:
                if (bSunday) {
                    ...
                    binding.txtSunday.setBackground(getResources().getDrawable(R.drawable.circle_spa_salon_doctor));
    ...
    private void getData(String cat_id) {
        ...
        pd = new ProgressDialog(SpaAndSalonBusinessSelectTimeActivity.this);
        pd.setMessage("Please Wait.....");
        pd.setCancelable(false);
        pd.show();

        Api api = RetrofitClient.getClient().create(Api.class);
        Call<ResponseHoursTitleList> call = api.getSpaAndSalonHoursTitleList("Bearer " + WS_URL_PARAMS.createJWT(WS_URL_PARAMS.issuer, WS_URL_PARAMS.subject),
        ...
        call.enqueue(new Callback<ResponseHoursTitleList>() {
            ...
            public void onResponse(Call<ResponseHoursTitleList> call, Response<ResponseHoursTitleList> response) {
                ...
                Log.e("responseSapAndSalonTitle", new Gson().toJson(response.body()));
                ...
                if (response.body() != null && response.isSuccessful()) {
                    ...
                    if (response.body().getError()) {
                        ...
                        Toast.makeText(SpaAndSalonBusinessSelectTimeActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(SpaAndSalonBusinessSelectTimeActivity.this, getResources().getString(R.string.error_admin), Toast.LENGTH_SHORT).show();
    ...
    public void sendData() {
        ...
        if (sunday.equals("0") && monday.equals("0") && tuesday.equals("0") && wednesday.equals("0") && thursday.equals("0") && friday.equals("0") && saturday.equals("0")) {
            ...
            pd.dismiss();
            Toast.makeText(SpaAndSalonBusinessSelectTimeActivity.this, "Please Select WeekDays", Toast.LENGTH_SHORT).show();


        } else if (rest_open.equals("0")) {
            pd.dismiss();
            Toast.makeText(SpaAndSalonBusinessSelectTimeActivity.this, "Please Select restaurant Open Time", Toast.LENGTH_SHORT).show();
        } else if (rest_close.equals("0")) {
            pd.dismiss();
            Toast.makeText(SpaAndSalonBusinessSelectTimeActivity.this, "Please Select restaurant Close Time", Toast.LENGTH_SHORT).show();
        } else {
            ...
            Api api = RetrofitClient.getClient().create(Api.class);
            Call<ResponseSendTiming> call = api.sendSpaAndSalonTiming("Bearer " + WS_URL_PARAMS.createJWT(WS_URL_PARAMS.issuer, WS_URL_PARAMS.subject),
            ...
            call.enqueue(new Callback<ResponseSendTiming>() {
                ...
                public void onResponse(Call<ResponseSendTiming> call, Response<ResponseSendTiming> response) {
                    ...
                    Log.e("responseSapAndSalonSendTiming", new Gson().toJson(response.body()));
                    if (pd.isShowing()) {
                        pd.dismiss();
                    }
                    if (response.body() != null && response.isSuccessful()) {
                        ...
                        if (response.body().getError()) {
                            ...
                            Intent intent = new Intent(SpaAndSalonBusinessSelectTimeActivity.this, SpaAndSalonBusinessTimingListActivity.class);
                            finish();
