...
public class DoctorCustomerActivity extends AppCompatActivity {

    ActivityDoctorCustomerBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_doctor_customer);
...
*/
    ...
    private void getData(String userId) {
        ...
        pd = new ProgressDialog(DoctorCustomerActivity.this);
        pd.setMessage("Please Wait....");
        pd.setCancelable(false);
        pd.show();

        Api api = RetrofitClient.getClient().create(Api.class);
        Call<ResponseCustomerList> call = api.getDoctorCustomerList("Bearer " + WS_URL_PARAMS.createJWT(WS_URL_PARAMS.issuer, WS_URL_PARAMS.subject),
            ...
            public void onResponse(Call<ResponseCustomerList> call, Response<ResponseCustomerList> response) {
                ...
                if (response.body() != null && response.isSuccessful()) {
                    ...
                    if (response.body().getError()) {
                        ...
                        Toast.makeText(DoctorCustomerActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();

                    } else {

                        customerList = response.body().getCustomerList();

                        adapter = new CustomerListAdapter(customerList, DoctorCustomerActivity.this);

                        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(DoctorCustomerActivity.this);
                    ...
                    Toast.makeText(DoctorCustomerActivity.this, getResources().getString(R.string.error_admin), Toast.LENGTH_SHORT).show();
