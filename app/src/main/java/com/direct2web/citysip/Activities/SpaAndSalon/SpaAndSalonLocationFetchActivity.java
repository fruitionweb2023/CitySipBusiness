...
import com.direct2web.citysip.databinding.ActivityDoctorLocationFetchBinding;
import com.direct2web.citysip.databinding.ActivitySpaSalonLocationFetchBinding;
...
public class SpaAndSalonLocationFetchActivity extends FragmentActivity implements OnMapReadyCallback, LocationListener, GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener {

    ActivitySpaSalonLocationFetchBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_spa_salon_location_fetch);
        ...
        binding.btnVerify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (address.equals("")) {
                    ...
                    Toast.makeText(SpaAndSalonLocationFetchActivity.this, "Please Wait", Toast.LENGTH_SHORT).show();
                    ...
                    if (new ConnectionToInternet(SpaAndSalonLocationFetchActivity.this).isConnectingToInternet()) {
                        sendProfile(sessionManager.getUserId());
                    } else {
                        new ConnectionToInternet(SpaAndSalonLocationFetchActivity.this).ShowDilog(SpaAndSalonLocationFetchActivity.this);
                    }
                }
    ...
    private void sendProfile(String userId) {
        ...
        pd = new ProgressDialog(SpaAndSalonLocationFetchActivity.this);
            ...
            public void onResponse(Call<ResponseSpaAndSalonSaveProfile> call, Response<ResponseSpaAndSalonSaveProfile> response) {
                ...
                if (response.body() != null && response.isSuccessful()) {
                    ...
                    if (!response.body().getError()) {
                        ...
                        sessionManager.setDoctor(true);
                        Intent i = new Intent(SpaAndSalonLocationFetchActivity.this, SapAndSalonDeshboardActivity.class);
                        finish();
                        startActivity(i);

                    } else {
                        Toast.makeText(SpaAndSalonLocationFetchActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
                    }

                } else {
                    Toast.makeText(SpaAndSalonLocationFetchActivity.this, getResources().getString(R.string.error_admin), Toast.LENGTH_SHORT).show();
    ...
    private void configureCameraIdle() {
        onCameraIdleListener = new GoogleMap.OnCameraIdleListener() {
            ...
            public void onCameraIdle() {
                ...
                Geocoder geocoder = new Geocoder(SpaAndSalonLocationFetchActivity.this);
