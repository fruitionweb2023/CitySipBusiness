...
import com.direct2web.citysip.databinding.ActivitySpaSalonAddVedioBinding;
...
public class SpaAndSalonAddVedioActivity extends AppCompatActivity implements AddAndSetVedioListSpaAndSalonAdapter.OnItemClickListner, AddAndSetVedioListSpaAndSalonAdapter.OnVideoItemClickListner {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_spa_salon_add_vedio);
        ...
        binding.imgDelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SpaAndSalonAddVedioActivity.this, SpaAndSalonDeleteVideoActivity.class);
        ...
        if (requestCode == REQUEST_TAKE_GALLERY_VIDEO) {
            if (resultCode == RESULT_OK) {
                ...
                if (path != null) {
                    ...
                    if (file.exists()) {
                        startActivityForResult(new Intent(SpaAndSalonAddVedioActivity.this,
                                        VideoTrimmerActivity.class).putExtra("EXTRA_PATH", path),
                                VIDEO_TRIM);
                        overridePendingTransition(0, 0);
                    } else {
                        Toast.makeText(SpaAndSalonAddVedioActivity.this, "Please select proper video", Toast.LENGTH_LONG);
                    }
                }
            }
            ...
            if (resultCode == RESULT_OK) {
                if (data != null) {
                    ...
                    Toast.makeText(SpaAndSalonAddVedioActivity.this, videoPath, Toast.LENGTH_LONG).show();
                }
            }
        }
    }
    ...
    private String getPath2(Uri uri) {
        ...
        if (isKitKat && DocumentsContract.isDocumentUri(this, uri)) {
            ...
            // DownloadsProvider
                ...
                return getDataColumn(SpaAndSalonAddVedioActivity.this, contentUri, null, null);
            }
            // MediaProvider
            ...
            public void onResponse(Call<ResponseSpaAndSalonAddImageAndVedio> call, Response<ResponseSpaAndSalonAddImageAndVedio> response) {
                ...
                if (response.body() != null && response.isSuccessful()) {
                    ...
                    if (response.body().getError()) {
                        Toast.makeText(SpaAndSalonAddVedioActivity.this, "" + response.body().getMessage(), Toast.LENGTH_SHORT).show();
                    } else {
                    ...
                    Toast.makeText(SpaAndSalonAddVedioActivity.this, getResources().getString(R.string.error_admin), Toast.LENGTH_SHORT).show();
    ...
    public void sendData() {
        ...
        pd = new ProgressDialog(SpaAndSalonAddVedioActivity.this);
        pd.setMessage("Please Wait.....");
        pd.setCancelable(false);
        pd.show();
        ...
        Call<ResponseSpaAndSalonAddVedio> call = api.sendSpaAndSalonVedio(header, t2, t1, body);
        call.enqueue(new Callback<ResponseSpaAndSalonAddVedio>() {
            @Override
            public void onResponse(Call<ResponseSpaAndSalonAddVedio> call, Response<ResponseSpaAndSalonAddVedio> response) {
                ...
                if (response.body() != null && response.isSuccessful()) {
                    ...
                    if (response.body().getError()) {
                        ...
                        Toast.makeText(SpaAndSalonAddVedioActivity.this, "Successfully Updated", Toast.LENGTH_SHORT).show();
                    }
                }
            }

            @Override
            public void onFailure(Call<ResponseSpaAndSalonAddVedio> call, Throwable t) {
