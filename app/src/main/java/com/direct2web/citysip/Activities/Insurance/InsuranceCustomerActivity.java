...
import com.direct2web.citysip.databinding.ActivityInsuranceCustomerBinding;
...
public class InsuranceCustomerActivity extends AppCompatActivity {

    ActivityInsuranceCustomerBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_insurance_customer);
...
*/
    ...
    private void getData(String userId) {
        ...
        pd = new ProgressDialog(InsuranceCustomerActivity.this);
        pd.setMessage("Please Wait....");
        pd.setCancelable(false);
        pd.show();

        Api api = RetrofitClient.getClient().create(Api.class);
        Call<ResponseCustomerList> call = api.getInsuranceCustomerList("Bearer " + WS_URL_PARAMS.createJWT(WS_URL_PARAMS.issuer, WS_URL_PARAMS.subject),
            ...
            public void onResponse(Call<ResponseCustomerList> call, Response<ResponseCustomerList> response) {
                ...
                if (response.body() != null && response.isSuccessful()) {
                    ...
                    if (response.body().getError()) {
                        ...
                        Toast.makeText(InsuranceCustomerActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();

                    } else {

                        customerList = response.body().getCustomerList();

                        adapter = new CustomerListAdapter(customerList, InsuranceCustomerActivity.this);

                        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(InsuranceCustomerActivity.this);
                    ...
                    Toast.makeText(InsuranceCustomerActivity.this, getResources().getString(R.string.error_admin), Toast.LENGTH_SHORT).show();
