...
import com.direct2web.citysip.databinding.ActivityDoctorEditLocationFetchBinding;
import com.direct2web.citysip.databinding.ActivityEditInsuranceLocationFetchBinding;
...
public class InsurenceEditLocationFetchActivity extends FragmentActivity implements OnMapReadyCallback, LocationListener, GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener {

    ActivityEditInsuranceLocationFetchBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_edit_insurance_location_fetch);
        ...
        binding.btnVerify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (address.equals("")) {
                    ...
                    Toast.makeText(InsurenceEditLocationFetchActivity.this, "Please Wait", Toast.LENGTH_SHORT).show();
                    ...
                    if (new ConnectionToInternet(InsurenceEditLocationFetchActivity.this).isConnectingToInternet()) {
                        sendProfile(sessionManager.getUserId());
                    } else {
                        new ConnectionToInternet(InsurenceEditLocationFetchActivity.this).ShowDilog(InsurenceEditLocationFetchActivity.this);
                    }
                }
    ...
    private void sendProfile(String userId) {
        ...
        pd = new ProgressDialog(InsurenceEditLocationFetchActivity.this);
        ...
        call.enqueue(new Callback<ResponseSendProfile>() {
            ...
            public void onResponse(Call<ResponseSendProfile> call, Response<ResponseSendProfile> response) {
                ...
                Log.e("responseInsurenceEditLocation", new Gson().toJson(response.body()));
                pd.dismiss();
                if (response.body() != null && response.isSuccessful()) {

                    if (!response.body().getError()) {

                        Intent i = new Intent(InsurenceEditLocationFetchActivity.this, InsuranceAboutBusinessActivity.class);
                        finish();
                        startActivity(i);

                    } else {
                        Toast.makeText(InsurenceEditLocationFetchActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
                    }

                } else {
                    Toast.makeText(InsurenceEditLocationFetchActivity.this, getResources().getString(R.string.error_admin), Toast.LENGTH_SHORT).show();
    ...
    private void configureCameraIdle() {
        onCameraIdleListener = new GoogleMap.OnCameraIdleListener() {
            ...
            public void onCameraIdle() {
                ...
                Geocoder geocoder = new Geocoder(InsurenceEditLocationFetchActivity.this);
