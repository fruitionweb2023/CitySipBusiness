...
public class DoctorEditAboutYouActivity extends AppCompatActivity {

    ActivityDoctorEditAboutYouBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_doctor_edit_about_you);
        ...
        binding.edtRestWebsite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(DoctorEditAboutYouActivity.this, date, calendar1
        ...
        binding.btnVerify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (binding.edtRestName.getText().toString().equals("")) {
                    ...
                    if (new ConnectionToInternet(DoctorEditAboutYouActivity.this).isConnectingToInternet()) {
                        editProfile(sessionManager.getUserId());
                    } else {
                        new ConnectionToInternet(DoctorEditAboutYouActivity.this).ShowDilog(DoctorEditAboutYouActivity.this);
                    }
    ...
    private void editProfile(String userId) {
        ...
        pd = new ProgressDialog(DoctorEditAboutYouActivity.this);
            ...
            public void onResponse(Call<ResponseSendProfile> call, Response<ResponseSendProfile> response) {
                ...
                if (response.body() != null && response.isSuccessful()){
                    ...
                    if (!response.body().getError()){
                        ...
                        Intent i = new Intent(DoctorEditAboutYouActivity.this, DoctorAboutBusinessActivity.class);
                        finish();
                        startActivity(i);

                    }else {
                        Toast.makeText(DoctorEditAboutYouActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
                    }

                }else {
                    Toast.makeText(DoctorEditAboutYouActivity.this, getResources().getString(R.string.error_admin), Toast.LENGTH_SHORT).show();
