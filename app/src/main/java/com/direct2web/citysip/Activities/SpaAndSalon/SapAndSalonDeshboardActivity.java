...
import com.direct2web.citysip.databinding.ActivityDoctorDeshboardBinding;
import com.direct2web.citysip.databinding.ActivitySpaAndSalonDeshboardBinding;
...
public class SapAndSalonDeshboardActivity extends AppCompatActivity {

    ActivitySpaAndSalonDeshboardBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_spa_and_salon_deshboard);
        ...
        binding.txtOrderView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SapAndSalonDeshboardActivity.this, SpaAndSalonAppointmentActivity.class);
        ...
        binding.txtCustomerView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SapAndSalonDeshboardActivity.this, SpaAndSalonCustomerActivity.class);
                startActivity(intent);
            }
        });
        ...
        binding.txtInActiveMenu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SapAndSalonDeshboardActivity.this, SpaAndSalonServicesActivity.class);
                startActivity(intent);
            }
        });
        ...
        binding.txtActiveOffer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SapAndSalonDeshboardActivity.this, SpaAndSalonCouponsActivity.class);
                startActivity(intent);
            }
        });
    ...
    private void getDashboardData(String userId) {
        ...
        pd = new ProgressDialog(SapAndSalonDeshboardActivity.this);
        ...
        Call<ResponseSpaAndSalonDeshboard> call = api.getSpaAndSalonDeshboardDetails("Bearer " + WS_URL_PARAMS.createJWT(WS_URL_PARAMS.issuer, WS_URL_PARAMS.subject),
                WS_URL_PARAMS.access_key, userId);

        call.enqueue(new Callback<ResponseSpaAndSalonDeshboard>() {
            @Override
            public void onResponse(Call<ResponseSpaAndSalonDeshboard> call, Response<ResponseSpaAndSalonDeshboard> response) {
                ...
                if (response.body() != null && response.isSuccessful()) {
                    ...
                    if (response.body().getError()) {
                        ...
                        Toast.makeText(SapAndSalonDeshboardActivity.this, "Error", Toast.LENGTH_SHORT).show();
                    } else {
                    ...
                    Toast.makeText(SapAndSalonDeshboardActivity.this, getResources().getString(R.string.error_admin), Toast.LENGTH_SHORT).show();

                }
            }

            @Override
            public void onFailure(Call<ResponseSpaAndSalonDeshboard> call, Throwable t) {
                if (pd.isShowing()) {
                    pd.dismiss();
                }
                t.printStackTrace();
                Log.e("spadeshboarderror", t.getMessage());
    ...
    public void onBackPressed() {
        if (doubleBackToExitPressedOnce) {
            Intent intent = new Intent(SapAndSalonDeshboardActivity.this, CategoryActivity.class);
            startActivity(intent);
            return;
        }
